...
- (void)viewDidLoad {
    ...
    [texturedBackgroundView setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"background.png"]]];
    ...
    [backButton setBackgroundImage:[UIImage imageNamed:@"backButton.pmg"] forState:UIControlStateHighlighted];
