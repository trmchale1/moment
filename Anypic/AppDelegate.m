...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // Parse initialization
     [Parse setApplicationId:@"uYVP1yAPvV6BoCj8JjrutUpAVh3x1VPYP5CBVhrZ" clientKey:@"GiH9NR0WgwfxM72QrknSXXk3hrgDsxe3hmo4Df3I"];
    //
    ...
    // You may set one up at https://developers.facebook.com/apps
     [PFFacebookUtils initializeWithApplicationId:@"574204326032175"];
    // ****************************************************************************
...
- (void)setupAppearance {
  ...
  //  [[UINavigationBar appearance] setTintColor:[UIColor colorWithRed:0.498f green:0.388f blue:0.329f alpha:1.0f]];
    ...
    [[UIButton appearanceWhenContainedIn:[UINavigationBar class], nil] setBackgroundImage:[UIImage imageNamed:@"ButtonOnNavigationBar.png"] forState:UIControlStateNormal];
